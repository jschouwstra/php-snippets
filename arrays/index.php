...
<p>
	...
	<form action="" method="post">
		Firstname <input type="text" value="fword" name="firstName">

		<input type="submit" name="submitInput" value="Ok">	
	</form>
	<?php
		if(isset($_POST['submitInput'])){
			$formInput = $_POST['firstName'];
			if(strpos($formInput, 'fword') !== false) {
				$needle = 'fword';
				$replacement = 'f***';

				$newInput = str_replace($needle, $replacement, $formInput);
				echo $newInput;
			}
		}
...
$maxiterations = 5;
foreach ($Thisarray as $data) {
  if ($i < $maxiterations) {
    if (isset($data['name']) != 'some_value') {
...
$seatsQuantity = 2;
$seatsArray = array(
	array('id' => '1','seat' => '1', 'taken' => '0'),
	array('id' => '2','seat' => '2', 'taken' => '0'),
	array('id' => '3','seat' => '3', 'taken' => '0'),
	array('id' => '4','seat' => '4', 'taken' => '1'),
	);
// $seatsArray = array_fill( 2, 2, "halo" );
//$seatsFilledArray = array_fill( 4, 4, $seatsArray );
